...
<div class="flex flex-col flex-wrap justify-center items-center w-11/12 text-eggshell">
	<Icon icon="mdi:compass-rose" style="font-size: 64px;" class="text-goldenrod"/>
